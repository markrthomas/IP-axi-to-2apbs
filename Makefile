...
SIMPLE_TB = tb_axi4_to_apb4_2x_simple.v
SIMPLE_RTL = axi4_to_apb4_2x_simple.v
BURST_TB = tb_axi4_to_apb4_2x_burst.v
BURST_RTL = axi4_to_apb4_2x_burst.v
SIMPLE_WS_TB = tb_axi4_to_apb4_2x_simple_ws.v
WAIT_CYCLES ?= 2

.PHONY: test-simple test-simple-ws test-simple-ws-sweep test-burst test-all lint clean
...
clean:
	rm -f sim_simple sim_burst sim_simple_ws_*
