...
module tb_uvm_burst_ext;
  ...
  axi4_to_apb4_2x_burst #(
      ...
      .PSTRB0(PSTRB0),
      .PRDATA0(PRDATA0),
      .PREADY0(side.PREADY0),
      .PSLVERR0(side.PSLVERR0),
      .PADDR1(PADDR1),
      .PPROT1(PPROT1),
      .PSEL1(PSEL1),
      .PENABLE1(PENABLE1),
      ...
      .PSTRB1(PSTRB1),
      .PRDATA1(PRDATA1),
      .PREADY1(side.PREADY1),
      .PSLVERR1(side.PSLVERR1)
  );
  ...
  apb_ext_mem_dual #(
      ...
      .PENABLE0(PENABLE0),
      .PWRITE0(PWRITE0),
      .PREADY0_in(side.PREADY0),
      .PSEL1(PSEL1),
      .PENABLE1(PENABLE1),
      .PWRITE1(PWRITE1),
      .PREADY1_in(side.PREADY1),
      .PWDATA0(PWDATA0),
      .PWDATA1(PWDATA1),
      .PRDATA0(PRDATA0),
      .PRDATA1(PRDATA1)
